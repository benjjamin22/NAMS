...
async function getData() {
    ...
    nuasa.forEach((user) => {
        ...
        listItems.push(div)
        div.innerHTML = `<a style="text-decoration:none;" onclick="ovieselected('${user._id}')"href="#">
        <div class="movie">
...
async function getmovie() {
  ...
  const html = id.map(user => {
      ...
      li.innerHTML = `
      <div class="profile-top" style="margin-top: 0rem;justify-content: center;background-image: url('/public/op.JPG');background-repeat: no-repeat;background-size: cover;padding: 20px 0px;" >
